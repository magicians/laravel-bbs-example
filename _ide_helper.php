...
namespace {
    ...
    class Cache extends \Illuminate\Support\Facades\Cache{
        ...
        public static function increment($key, $value = 1){
            return \Illuminate\Cache\ApcStore::increment($key, $value);
        }
        ...
        public static function decrement($key, $value = 1){
            return \Illuminate\Cache\ApcStore::decrement($key, $value);
        }
        ...
        public static function getPrefix(){
            return \Illuminate\Cache\ApcStore::getPrefix();
        }
        ...
        public static function section($name){
            ...
            return \Illuminate\Cache\ApcStore::section($name);
        }
        ...
        public static function tags($names){
            //Method inherited from \Illuminate\Cache\TaggableStore            
            return \Illuminate\Cache\ApcStore::tags($names);
        }
